...
Q31_SPEC = QuerySpec(
    query_id="Q3.1", query_group="G3", query_name="Multi-step Interaction Chain",
    logical_query_type="Bounded ERPQ / Reachability",
    rpq_expression="INTERACTS_WITH · INTERACTS_WITH{1,max_depth-1}",
    logical_query_description="Chuỗi tương tác có endpoint tương thích và thứ tự thời gian.",
    baseline_physical_plan="GLOBAL_MERGE_THEN_BOUNDED_ENDPOINT_CHAIN_JOIN",
    proposed_physical_plan="PARTITION_INTERACTION_LOCALEVAL_THEN_ENDPOINT_STITCHING",
    witness_type="interaction_chain", correctness_compare_columns=COMPARE_COLUMNS_Q31,
    local_event_extractor=q31_local_event_extractor, baseline_evaluator=q31_baseline_global_evaluator,
    distributed_evaluator=q31_distributed_evaluator,
    automaton_transitions=(("q0","INTERACTION_STEP","q1"),("q1","INTERACTION_STEP","q2")),
    automaton_accepting_states=("q2",), required_fragment_roles=("INTERACTION_STEP",),
    boundary_eligible_roles=("INTERACTION_STEP",), stitch_mode="INTERACTION_ENDPOINT_CHAIN",
    stitch_key_fields=("person_id","other_person_id"), stitch_role_order=("INTERACTION_STEP",),
    boundary_interfaces=(("INTERACTION_STEP","INTERACTION_STEP",("other_person_id",),("person_id",),"FORWARD","q1","q1"),),
    hard_constraint_names=("endpoint_compatibility","temporal_order","bounded_depth","no_cycle"),
    candidate_dedup_columns=("candidate_id",),
    witness_dedup_columns=tuple(COMPARE_COLUMNS_Q31),
    runtime_parameter_schema={"max_time_gap_seconds":"float", "maximum_chain_depth":"int"},
)
