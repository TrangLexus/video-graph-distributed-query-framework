...
def q11_complete_local_candidates(candidates: DataFrame, config: Stage2Config) -> DataFrame:
    """Complete local trajectory requires at least two observations."""
    del config
...
Q11_SPEC = QuerySpec(
    ...
    automaton_transitions=(("q0", "TRAJECTORY_SEGMENT", "q1"),("q1", "TRAJECTORY_SEGMENT", "q1")),
    ...
    boundary_interfaces=(("TRAJECTORY_SEGMENT","TRAJECTORY_SEGMENT",("entity_type","entity_id"),("entity_type","entity_id"),"FORWARD","q1","q1"),),
    hard_constraint_names=("same_entity", "temporal_order", "bounded_continuity", "query_time_scope"),
    candidate_dedup_columns=("candidate_id",),
    witness_dedup_columns=tuple(COMPARE_COLUMNS_Q11),
