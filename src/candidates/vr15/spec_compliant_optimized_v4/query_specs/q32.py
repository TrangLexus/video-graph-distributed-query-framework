...
Q32_SPEC = QuerySpec(
    query_id="Q3.2", query_group="G3", query_name="Indirect Interaction Detection",
    logical_query_type="Bounded reachability ERPQ", rpq_expression="INTERACTS_WITH{2,max_depth}",
    logical_query_description="Reachability gián tiếp giữa hai người thông qua endpoint trung gian.",
    baseline_physical_plan="GLOBAL_MERGE_THEN_TWO_STEP_REACHABILITY_JOIN",
    proposed_physical_plan="PARTITION_REACHABILITY_LOCALEVAL_THEN_ENDPOINT_STITCHING",
    witness_type="reachability_path", correctness_compare_columns=COMPARE_COLUMNS_Q32,
    local_event_extractor=q32_local_event_extractor, baseline_evaluator=q32_baseline_global_evaluator,
    distributed_evaluator=q32_distributed_evaluator,
    automaton_transitions=(("q0","REACHABILITY_STEP","q1"),("q1","REACHABILITY_STEP","q2")),
    automaton_accepting_states=("q2",), required_fragment_roles=("REACHABILITY_STEP",),
    boundary_eligible_roles=("REACHABILITY_STEP",), stitch_mode="INDIRECT_REACHABILITY",
    stitch_key_fields=("person_id","other_person_id"), stitch_role_order=("REACHABILITY_STEP",),
    boundary_interfaces=(("REACHABILITY_STEP","REACHABILITY_STEP",("other_person_id",),("person_id",),"FORWARD","q1","q1"),),
    hard_constraint_names=("endpoint_compatibility","temporal_order","bounded_depth","no_cycle"),
    candidate_dedup_columns=("candidate_id",),
    witness_dedup_columns=tuple(COMPARE_COLUMNS_Q32),
    runtime_parameter_schema={"max_time_gap_seconds":"float", "maximum_reachability_hops":"int"},
)
