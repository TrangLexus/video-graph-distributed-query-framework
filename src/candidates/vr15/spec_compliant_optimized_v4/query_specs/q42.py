...
Q42_SPEC = QuerySpec(
    ...
    boundary_interfaces=(("CARRY","INTERACT",("person_id",),("person_id",),"FORWARD","q1","q1"),("INTERACT","USE",("person_id",),("person_id",),"FORWARD","q2","q2")),
    ...
    witness_dedup_columns=tuple(COMPARE_COLUMNS_Q42),
