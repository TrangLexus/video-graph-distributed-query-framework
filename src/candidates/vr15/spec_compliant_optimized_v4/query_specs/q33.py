...
Q33_SPEC = QuerySpec(
    query_id="Q3.3", query_group="G3", query_name="Group Interaction Chain Across Locations",
    logical_query_type="ERPQ", rpq_expression="INTERACTS_WITH+ · observation_context+",
    logical_query_description="Chuỗi tương tác nhóm có bằng chứng tại nhiều location.",
    baseline_physical_plan="GLOBAL_MERGE_THEN_INTERACTION_CHAIN_LOCATION_AGGREGATION",
    proposed_physical_plan="PARTITION_GROUP_INTERACTION_LOCALEVAL_THEN_CHAIN_STITCHING",
    witness_type="group_interaction_chain", correctness_compare_columns=COMPARE_COLUMNS_Q33,
    local_event_extractor=q33_local_event_extractor, baseline_evaluator=q33_baseline_global_evaluator,
    distributed_evaluator=q33_distributed_evaluator,
    automaton_transitions=(("q0","GROUP_INTERACTION_STEP","q1"),("q1","GROUP_INTERACTION_STEP","q2")),
    automaton_accepting_states=("q2",), required_fragment_roles=("GROUP_INTERACTION_STEP",),
    boundary_eligible_roles=("GROUP_INTERACTION_STEP",), stitch_mode="GROUP_INTERACTION_CHAIN",
    stitch_key_fields=("person_id","other_person_id"), stitch_role_order=("GROUP_INTERACTION_STEP",),
    boundary_interfaces=(("GROUP_INTERACTION_STEP","GROUP_INTERACTION_STEP",("other_person_id",),("person_id",),"FORWARD","q1","q1"),),
    hard_constraint_names=("endpoint_compatibility","temporal_order","minimum_distinct_locations","minimum_group_size"),
    candidate_dedup_columns=("candidate_id",),
    witness_dedup_columns=tuple(COMPARE_COLUMNS_Q33),
