...
def _events_from_global_graph(vertices: DataFrame, base_edges: DataFrame, config: Stage2Config, query_id: str) -> DataFrame:
    ...
    to avoid comparing two different Q4.3 implementations.
    """
...
Q43_SPEC = QuerySpec(
    ...
    # Local extractor phát các role tổng quát trước khi GlobalEval gán P1/P2.
    # Khai báo tại QuerySpec để Proposed không hard-code theo query_id.
    boundary_role_pairs=(("CARRY","INTERACT"),("INTERACT","CARRY"),("CARRY","USE"),("INTERACT","USE")),
