...
def q23_complete_local_candidates(candidates: DataFrame, config: Stage2Config) -> DataFrame:
    """Ordered-location candidate hoàn thành khi target subsequence đã xuất hiện."""
...
Q23_SPEC = QuerySpec(
    ...
    automaton_transitions=(("q0","ORDERED_LOCATION","q1"),), automaton_accepting_states=("q1",),
    ...
    hard_constraint_names=("same_entity","target_location_order","temporal_order"),
