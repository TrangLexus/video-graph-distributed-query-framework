...
# ============================================================
# VideoGraphDB Official Benchmark - Correctness only
#
# Purpose:
#   Run correctness validation for multiple queries over all
#   configured datasets. This script DOES NOT run timing benchmark.
#
# Usage:
#   chmod +x run_correctness_all_queries.sh
#   ./run_correctness_all_queries.sh
#
# Output:
...
LOG_FILE="${LOG_DIR}/run_correctness_all_queries_${RUN_ID}.log"
STATUS_FILE="${STATUS_DIR}/run_correctness_status_${RUN_ID}.csv"

# ------------------------------------------------------------
# Query list
# Edit this list when needed.
# Examples: Q1.1 Q1.2 Q1.3 Q2.1 Q2.2 Q2.3 Q3.1 Q3.2 Q3.3 Q4.1 Q4.2 Q4.3 Q14
# ------------------------------------------------------------
QUERIES=(
  "Q1.1"
  "Q1.2"
...
# ------------------------------------------------------------
# Query parameters
# These parameters are accepted globally by run_experiment.py.
# They mainly affect Q14/Q4.3-style temporal trajectory queries.
# ------------------------------------------------------------
...
{
  echo "============================================================"
  echo "VideoGraphDB correctness-only run"
  echo "Run ID:       ${RUN_ID}"
