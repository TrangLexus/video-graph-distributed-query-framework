...
Q13_SPEC = QuerySpec(
    ...
    aliases=(),
    query_group="G1",
    query_name="Multi-location Movement Detection",
    logical_query_type="ERPQ with aggregate constraint",
    rpq_expression="(DETECTED_IN·RECORDED_BY·LOCATED_AT)·NEXT_TW_*",
    physical_plan="location_segment_grouping_and_distinct_location_validation",
    witness_type="multi_location_trajectory",
    compare_columns=COMPARE_COLUMNS_Q13,
    local_event_extractor=q13_local_event_extractor,
    baseline_evaluator=q13_baseline_global_evaluator,
