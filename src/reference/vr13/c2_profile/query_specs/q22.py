...
Q22_SPEC = QuerySpec(
    ...
    aliases=(),
    query_group="G2",
    query_name="Temporal Continuity Checking",
    logical_query_type="Bounded ERPQ",
    rpq_expression="DETECTED_IN·(NEXT_TW_*·DETECTED_IN){m,n}",
    physical_plan="ordered_detection_gap_validation",
    witness_type="temporal_continuity",
    compare_columns=COMPARE_COLUMNS_Q22,
    local_event_extractor=q22_local_event_extractor,
    baseline_evaluator=q22_baseline_global_evaluator,
