...
# ============================================================
# VideoGraphDB C1 - Official Benchmark - One query
#
# Purpose:
#   Run the official lazy/end-to-end runtime benchmark for one
...
#   ./scripts/run_one_query_official.sh Q1.1
#
# Optional env overrides:
#   DATASETS=dataset_1m OFFICIAL_REPEATS=1 ./scripts/run_one_query_official.sh Q2.3
# ============================================================
...
LOG_FILE="${LOG_DIR}/run_one_query_official_${QUERY_TAG}_${RUN_ID}.log"
STATUS_FILE="${STATUS_DIR}/run_one_query_official_status_${QUERY_TAG}_${RUN_ID}.csv"

DATASETS="${DATASETS:-dataset_1m,dataset_2m,dataset_4m,dataset_6m,dataset_8m,dataset_10m}"
OFFICIAL_REPEATS="${OFFICIAL_REPEATS:-${TIMING_REPEATS:-1}}"
...

{
  ...
  echo "============================================================"
  echo "VideoGraphDB one-query official benchmark"
  echo "Run ID:       ${RUN_ID}"
...
PY
  ...
  echo
  echo "Step 3/3 - Official benchmark"
