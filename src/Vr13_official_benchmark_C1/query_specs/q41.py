...
Q41_SPEC = QuerySpec(
    ...
    aliases=(),
    query_group="G4",
    query_name="Multi-factor Suspicious Behavior Detection",
    logical_query_type="Composite ERPQ",
    rpq_expression="CARRIES(P,T) ∧ INTERACTS_WITH(P,P2) ∧ multi-location(P)",
    physical_plan="bounded_conjunctive_factor_join_and_location_aggregation",
    witness_type="multi_factor_behavior",
    compare_columns=COMPARE_COLUMNS_Q41,
    local_event_extractor=q41_local_event_extractor,
    baseline_evaluator=q41_baseline_global_evaluator,
