...
def build_env(args: argparse.Namespace) -> dict[str, str]:
    ...
    is_profiling = args.mode == "profiling"
    is_runtime_only = args.mode == "official_runtime_only"
...
def main() -> None:
    ...
    parser.add_argument(
        "--mode",
        choices=["correctness", "official", "official_runtime_only", "timing", "profiling"],
        default="correctness",
        help=(
    ...
    skip_witness_comparison = args.mode == "official_runtime_only"
    ...
    if skip_witness_comparison:
        print(
            "[INFO] Witness-set comparison skipped because mode=official_runtime_only "
